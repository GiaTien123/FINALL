<footer>
         <div class="footer" style="position:relative; bottom:0px">
            <div class="container" style="position:relative; bottom:0px">
               <div class="row">
                  <div class="col-md-3">
                     <a class="logo_footer"  href="index.html"><img src="<?php echo URLROOT; ?>images/skytunlogo.png" style="height:60px" alt="#" /></a>
                  </div>
                  <div class="col-md-9">
      ...
      <script src="<?php echo URLROOT;?>js/jquery-3.0.0.min.js"></script>
